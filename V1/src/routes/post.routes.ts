...
router.patch('/:id/assign', validate(assignPostSchema), postController.assignToUser);
router.patch('/:id/status', validate(updateStatusSchema), postController.updateStatus);
router.patch('/:id/due-date', validate(updateDueDateSchema), postController.updateDueDate);
