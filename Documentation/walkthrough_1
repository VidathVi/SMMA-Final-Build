# Walkthrough: GEO Engine Microservice Integration (Backend)

We have successfully updated the backend to integrate with the new Modal vLLM serverless microservice, replacing the local FastAPI fallback.
