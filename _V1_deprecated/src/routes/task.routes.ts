...
router.patch('/:postId/move', validate(moveTaskSchema), taskController.moveTask);
router.get('/board/:campaignId', validate(boardViewSchema), taskController.getBoardView);
