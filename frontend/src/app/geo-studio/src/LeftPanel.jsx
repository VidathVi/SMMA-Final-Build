                    ...
                    <div className="file-info">
                      ...
                      <div className="file-details">
                        ...
                        <span className="file-size">
                          {(formData.attachedFile.size / 1024).toFixed(1)} KB
                        </span>
                      </div>
                    </div>
              ...
              >
                ...
                >
                  ...
                  >
                    <Sliders
                      size={18}
                      className={showAdvanced ? "text-neon-blue" : ""}
                      style={{
                        color: showAdvanced
                          ? "var(--geo-neon-blue)"
                          : "var(--geo-text-secondary)",
                      }}
                    />
                    <span
                      style={{
                ...
                <div className="advanced-content">
                  <div className="range-input-group">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleAdvancedChange("density", e.target.value)
                      }
                    />
                  </div>
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleAdvancedChange("creativity", e.target.value)
                      }
                    />
                  </div>
                  ...
                  >
                    <div className="input-group" style={{ marginBottom: 0 }}>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleAdvancedChange("audience", e.target.value)
                        }
                      >
                    ...
                    <div className="input-group" style={{ marginBottom: 0 }}>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleAdvancedChange("length", e.target.value)
                        }
                      >
