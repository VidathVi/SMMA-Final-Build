      ...
      <section className="right-panel">
        <div className="results-placeholder">
          <div className="placeholder-content">
            ...
            <p>
              Configure your content settings and run the analysis to see
              AI-generated variations here.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
          <GlassCard glowColor="rgba(0, 210, 255, 0.15)">
            ...
            <div className="content-preview">
              <div className="content-text">{currentVariation.content}</div>
            </div>
            ...
            <div className="action-buttons">
              <button
                ...
                onClick={() => console.log("Edit Caption Clicked")}
              >
                Edit Caption
              </button>
              <button
