...
function App() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "personal":
        return <PersonalProfile user={user} onUpdate={handleUserUpdate} />;
      case "organization":
        return <OrganizationProfile org={org} onUpdate={handleOrgUpdate} />;
      case "ai":
  ...
  const breadcrumbsText =
    activeTab === "personal"
      ...
      : activeTab === "organization"
        ...
        : activeTab === "ai"
          ? "Profile & Settings / AI & Integrations"
          : activeTab === "security"
  ...
  return (
    <div className="app-container">
      <Header userAvatar={user.avatar} breadcrumbs={breadcrumbsText} />
